        ...
        <div className="">
          ...
          <div className="mt-32 flex sm:flex-row flex-col justify-center items-center sm:items-start text-center sm:text-left w-full p-10">
            <div className="flex flex-col w-full sm:w-1/2">
              <div className="text-3xl font-bold text-primary ">{me.name}</div>
              <div className="text-xl text-slate-500">{me.email}</div>
              <div className="text-slate-300 text-sm font-bold  ">Director</div>
            ...
            <div className="flex flex-col w-full sm:w-1/2">
              ...
              <div className="text-slate-300 text-sm font-bold  ">
                ...
                <p className="text-xs text-gray-600 font-normal mt-2">
                  I’m a cybersecurity engineer and full-stack developer, serving
                  as Director at Emirl Builders. I lead development teams to
                  build secure, high-performance web systems. Merging my
                  expertise in cloud security, application architecture, and
                  agile management, I deliver resilient, user‑centric solutions
